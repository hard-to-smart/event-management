        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full px-2">
                3
              </span>
            </NavLink>
          </li>
          ...
          <li>
            <NavLink
              ...
              className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#C5B2A3] transition-all duration-200"
            >
              <RiLogoutBoxLine className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" />
